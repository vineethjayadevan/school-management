...
const targetAdmissions = ['2631', '2531', '2625', '2665'];
...
async function fixStudents() {
    ...
    for (const sheetName of targetSheets) {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            if (!dbStudent) {
                console.log(`Student ${admissionNo} not found in DB!`);
                continue;
            }
            ...
            try {
                ...
                console.log(`+ Fixed Student: ${dbStudent.name} (${admissionNo}) - Class: ${dbStudent.className}`);
                updatedCount++;
            } catch (err) {

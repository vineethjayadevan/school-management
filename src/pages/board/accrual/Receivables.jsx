...
export default function Receivables() {
    ...
    const fetchReceivables = async () => {
        ...
        try {
            ...
            const res = await api.get(`/accrual/receivables?${params.toString()}`);
    ...
    const totalOutstanding = receivables.reduce((sum, item) => sum + (item.balance || 0), 0);
                                ...
                                <tr>
                                    <td colSpan="6" className="px-6 py-12 text-center text-slate-500">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p>No receivables found matching filters.</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
